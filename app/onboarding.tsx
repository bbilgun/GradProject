...
const SLIDES = [
  {
    ...
    body: "Оюутны гарын авлагын мэдээллийг нэг дороос.",
    accent: BLUE,
  },
  {
    id: "2",
    ...
    badge: "AI Технологи",
    title: "ЧатБот",
    body: "AI туслахын тусламжтайгаар гарын авлагын агуулгаас хурдан, тодорхой хариулт авах боломжтой.",
    accent: GOLD,
  },
  {
    id: "3",
    ...
    title: "Хадгалахаад дараа нь унш",
    body: "ШУТИС-ийн гарын авлагатай танилцаж, өөрт хэрэгтэй бүлгүүдийг хадгалаарай.",
    accent: BLUE,
  },
];
  ...
  return (
    ...
    >
      ...
      <View style={{ flex: 1, justifyContent: "center", alignItems: "center" }}>
        <LottieErrorBoundary
          fallback={
            <FallbackIllustration icon={item.icon} accent={item.accent} />
          }
        >
    ...
    >
      ...
      <Animated.View
        style={{
          ...
          backgroundColor:
            accent === GOLD ? "rgba(255,194,13,0.12)" : "rgba(8,21,143,0.09)",
          alignItems: "center",
          justifyContent: "center",
